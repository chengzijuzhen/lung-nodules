...
[num_mal,sop_text,max_min_xy]=readxml(xml_path);  %函数调用
...
%---------------------------------读取dicom文件-------------------------------------
dcm_files = dir('E:\matlab\segmentation\dataset\dicom\0001\*.dcm'); % 获得文件列表                   
...
xlswrite('E:\matlab\segmentation\dataset\xls\0001\1.xls',total); %导入到表格中
